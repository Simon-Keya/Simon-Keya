  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Enhanced Action Buttons - Mobile Vertical Layout */}
        ...
        <motion.div
          ...
          // Added proper spacing for both layouts

          className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6 mb-12 w-full max-w-md sm:max-w-none mx-auto"
